...
resource "azurerm_virtual_machine_extension" "disk_init" {
  ...
  settings = jsonencode({
    fileUris = [
      "https://raw.githubusercontent.com/jswelborn/terraform-fdb-uk-sql/main/modules/sql_vm/initialize-disks.ps1",
      "https://raw.githubusercontent.com/jswelborn/terraform-fdb-uk-sql/main/modules/sql_vm/install-and-schedule.ps1"
    ],
